...
export function NewPasswordPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    if (err) { setError("Une erreur est survenue. Réessaie.") }
    else {
      setSuccèss(true)
        ...
        <div className="card auth-card">
          ...
          {succèss ? (
            ...
            <div className="form-error-banner">
              Lien invalidé ou expire. Redemande un lien de réinitialisation depuis la page de connexion.
            </div>
          ) : (
            <form onSubmit={handleSubmit}>
              ...
              <div className="field">
                ...
                <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Au moins 6 caractères" autoComplete="new-password" />
              </div>
              <div className="field">
                <label>Confirmer le mot de passe</label>
                <input type="password" value={confirm} onChange={(e) => setConfirm(e.target.value)} placeholder="Répète le mot de passe" autoComplete="new-password" />
              </div>
